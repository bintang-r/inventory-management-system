<div class="card">
            ...
            <tbody>
                @forelse ($products as $product)
                    <tr>
                        ...
                        <td class="align-middle text-center" x-data="{ bgColor: 'transparent' }"
    ...
    <div class="card-footer d-flex align-items-center">
        <p class="m-0 text-secondary">
            Tampilkan <span>{{ $products->firstItem() }}</span>
            di <span>{{ $products->lastItem() }}</span> pada <span>{{ $products->total() }}</span> baris
        </p>
