        ...
        <div class="container-xl">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                            <label class="small mb-1">Nomor Ponsel</label>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                            <label class="small mb-1">Nomor Pembelian</label>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                            <label class="small mb-1">Di Buat Oleh</label>
                            <div class="form-control form-control-solid">{{ $purchase->createdBy->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-6">
                            <label class="small mb-1">Di Edit Oleh</label>
